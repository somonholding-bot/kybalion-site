...
document.querySelectorAll('[data-email]').forEach(function(e){e.textContent=c.CONTACT_EMAIL||'(mailbox being set up)';if(c.CONTACT_EMAIL)e.href='mailto:'+c.CONTACT_EMAIL});
...
document.querySelectorAll('.callbtn').forEach(function(a){if(t&&t.number){a.href='tel:'+t.number;a.textContent='Prefer to talk? Call '+t.number;a.classList.add('on')}});
})();
